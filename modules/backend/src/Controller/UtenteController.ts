  ...
  static loginIMP = async (req: Request, res: Response) => {
    try {
      ...
      if (user) {
        ...
        console.log('Identificativo in login : ', req.sessionID); // stampo l'identificativo della sessione
        console.log('Salvo nella sessione : ', req.session!.authenticated); // stampo l'email dell'utente
